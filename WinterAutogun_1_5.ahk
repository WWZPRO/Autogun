...
global weaponlist := [{Name: "Assault Shotgun", ReloadTime: "1075", Bullets: 20, Type:"T3"},{Name: "Advanced Combat Weapon", ReloadTime: "1075", Bullets: 15, Type:"T3"},{Name: "Assault Carbine", ReloadTime: "1075", Bullets: 60, Type:"T3"},{Name: "Light Automatic Weapon", ReloadTime: "4400", Bullets: 125, Type:"T2"},{Name: "Goncho Mark II", ReloadTime: "600", Bullets: 3, Type:"T3"},{Name: "Battle Riffle", ReloadTime: "1075", Bullets: 25, Type:"T3"},{Name: "Bullpup Riffle", ReloadTime: "1075", Bullets: 45, Type:"T3"},{Name: "Sniper Riffle", ReloadTime: "1075", Bullets: 30, Type:"T2"},{Name: "Advanced SMG", ReloadTime: "1075", Bullets: 60, Type:"T3"},{Name: "Special SMG", ReloadTime: "1250", Bullets: 40, Type:"T3"},{Name: "Crossbow", ReloadTime: "1025", Bullets: 5, Type:"T3"},{Name: "Assault Rifle", ReloadTime: "1075", Bullets: 50, Type:"T2"},{Name: "Sporting Carbine", ReloadTime: "850", Bullets: 30, Type:"T2"},{Name: "Classic Battle Rifle", ReloadTime: "1100", Bullets: 30, Type:"T2"},{Name: "Classic Bullpup Riffle", ReloadTime: "1300", Bullets: 42,Type:"T2"},{Name: "SMG", ReloadTime: "1100", Bullets: 50, Type:"T2"},{Name: "Combat Shotgun",ReloadTime: "1000", Bullets: 12, Type:"T2"},{Name: "Scout Riffle", ReloadTime: "975", Bullets: 30, Type:"T1"},{Name: "Compact SMG", ReloadTime: "1050", Bullets: 48, Type:"T1"},{Name: "Shotgun", ReloadTime: "900", Bullets: 12, Type:"T1"},{Name: "Pistol", ReloadTime: "730", Bullets: 20, Type:"S"},{Name: "Machine Pistol", ReloadTime: "675", Bullets: 30, Type:"S"},{Name: "PDW", ReloadTime: "975", Bullets: 40, Type:"S"},{Name: "Compact Shotgun", ReloadTime: "900", Bullets: 4, Type:"S"},{Name: "Double Barrel Shotgun", ReloadTime: "750", Bullets: 2, Type:"S"},{Name: "Revolver", ReloadTime: "1050", Bullets: 6, Type:"S"},{Name: "Grenade Launcher", ReloadTime: "675", Bullets: 1, Type:"S"}]
...
ShowWeaps:
    Gui, weap:New
    Gui, Font, s15 
    Gui, Add, Text, x25 y10, Primaries: 
    for each, i in weapcustom {
        h := weapcustom[A_Index].Type
        name := weapcustom[A_Index].Name  
        If (h != "S") {
            Gui, Add, Radio, y+4 x50 vWeapP%A_Index% gSubmit_RadioPrim, %A_Index% %name%    
        }
    }
    Gui, Add, Text,x25 y+10, Secondaries: 
    for each, j in weapcustom {
        h := weapcustom[A_Index].Type
        name := weapcustom[A_Index].Name 
        If (h == "S") {
            Gui, Add, Radio, y+4 x50 vWeapS%A_Index% gSubmit_RadioSec, %A_Index% %name%    
        }
    }
    posX := (A_ScreenWidth/2)+350
    Gui, Show, w500 x%posX%
    Return
